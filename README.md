...
1. **Constant Folding** — evaluates compile-time expressions (`3 + 4` → `7`)
2. **Constant Propagation** — substitutes known constant values into expressions
3. **Dead Code Elimination** — removes unreachable or unused instructions
4. **Strength Reduction** — replaces expensive operations with cheaper equivalents
